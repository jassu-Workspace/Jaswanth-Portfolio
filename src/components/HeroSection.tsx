...
export default function HeroSection() {
  ...
  useEffect(() => {
    ...
    // Refresh ScrollTrigger after display:none is removed (parallax needs accurate dimensions)
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="content-wrap relative z-10"
        ...
        <div className="grid items-center gap-10 lg:grid-cols-[1.15fr_0.85fr]">
          <div>
            ...
            <motion.h1
              ...
              transition={{ duration: 0.65, ease: [0.22, 1, 0.36, 1] as const, delay: 0.05 }}
            >
              Jaswanth
           </motion.h1>

            <motion.p
              className="text-depth-soft mt-5 text-[clamp(1.3rem,3.5vw,2.2rem)] leading-tight text-[#21405b]"
              variants={itemVariants}
            >
              Designing intelligent products for unpredictable seas.
           </motion.p>

            <motion.p className="section-copy max-w-[60ch]" variants={itemVariants}>
            ...
            <motion.div className="mt-8 flex flex-wrap items-center gap-3" variants={itemVariants}>
              ...
              <motion.span
                ...
                transition={{ duration: 0.5, ease: [0.22, 1, 0.36, 1] as const, delay: 0.25 }}
              >
            ...
            <motion.div className="mt-10 flex flex-wrap gap-8" variants={itemVariants}>
              {[
          ...
          <motion.div
            ...
            className="hero-signal relative"
            variants={itemVariants}
          >
